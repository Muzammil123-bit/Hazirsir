...
import { View, Text, StyleSheet, ScrollView, TextInput, FlatList, Image, Slider, Modal, TouchableOpacity, Dimensions } from 'react-native';
...
class MyGigsDetails extends Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount() {
        ...
        this.setState({
            gig_user_id: user_id, order_id, title, requirements,
